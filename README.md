...
| `request` | Создание карточки запроса для дежурных инженеров (Duty Helper).                | [README](internal/commandsdocs/commands/request.md) |
| `init` | Инициализация утилиты, скачивание зависимостей и настройка контекстов.         |  [README](internal/commandsdocs/commands/init.md)   |
